...
- [AI Agent 开发框架技术选型调研（2026 全景）](./ai-agent-framework-selection-research.md) — 以"控制流哲学"（确定性图 / Agent 循环 / 多智能体 / 企业内核）为主轴，横切 8 维能力矩阵，深挖 7 个标杆框架；给出复杂度分级、一票否决、选型决策树、生产参考架构、两阶段 PoC 门禁与 2026 趋势，并覆盖 MCP/A2A/AG-UI 协议与国内模型生态。
